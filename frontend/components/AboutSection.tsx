        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-cyan-950 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8 pt-4 border-t border-stone-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {data.skills.left.slice(0, 2).map((skill: string, idx: number) => (
                    <div key={idx} className="flex items-center gap-3 text-stone-700">
                      <span className="w-6 h-6 rounded-full bg-teal-100 flex items-center justify-center text-green-900 shrink-0">
              ...
              <div className="sm:w-auto">
                <Button
                  asChild
                  size="lg"
                  className="w-full sm:w-auto rounded-full px-7 h-12 bg-green-900 hover:bg-cyan-900 text-white"
                >
                  <Link href="/about">
