  ...
  return (
    <section className="relative min-h-[75vh] md:min-h-[85vh] flex items-center bg-linear-to-br from-stone-50 via-white to-green-50/30 overflow-hidden py-8 md:py-10">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute top-[-15%] left-[-10%] w-[45%] h-[45%] bg-gree-200/25 rounded-full blur-3xl" />
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-green-800/30 text-green-950 hover:bg-cyan-50 hover:border-cyan-800/50 h-14 px-8 text-lg bg-white/50 backdrop-blur-sm rounded-full font-semibold w-full sm:flex-1"
              >
                <Link
                  href="/manifesto"
                  className="flex items-center justify-center"
          ...
          <div className="flex-1 w-full">
            ...
            <div className="mt-8 flex w-full items-center justify-center">
              <div className="flex items-center w-fit gap-3 bg-white/95 backdrop-blur-sm px-4 sm:px-10 py-3 rounded-full shadow-lg border border-green-200 sm:w-auto max-w-md">
                ...
                <span className="text-sm sm:text-base font-semibold text-cyan-950 uppercase tracking-wider text-center">
                  {data.partySlogan}
                </span>
              </div>
            </div>
