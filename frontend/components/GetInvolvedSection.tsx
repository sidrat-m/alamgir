    ...
    <section id="contact" className="py-24 bg-white">
      <div id="volunteer" className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-4xl font-serif font-bold text-cyan-950">{t.getInvolved.title}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto ">
          <div className="bg-stone-50 rounded-2xl p-8 border border-stone-200 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group ">
            <div className="w-20 h-20 bg-teal-100 rounded-full flex items-center justify-center mb-6 text-green-900 group-hover:scale-110 transition-transform">
            ...
            <Button
              asChild
              size="lg"
              className="w-full bg-green-900 hover:bg-cyan-950 text-white h-12 rounded-full"
            >
          ...
          >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="w-full border-stone-300 hover:bg-stone-200 h-12 rounded-full text-stone-700 bg-transparent"
            >
