      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-200 text-cyan-950 text-sm font-semibold mb-4">
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-stone-200/80 p-8 space-y-8">
                ...
                return (
                  <div
                    ...
                    className={`relative rounded-2xl border-2 transition-all cursor-pointer ${
                      isSelected
                        ? "border-green-600 bg-teal-50"
                        : showResults
                        ? "border-stone-300 bg-white"
                        : "border-stone-300 bg-white hover:border-green-400 hover:bg-green-100/20"
                    }`}
            ...
            {hasVoted && (
              <div className="bg-teal-50 border-2 border-green-200 rounded-lg p-6 text-center">
                <p className="text-cyan-950 font-semibold">✓ {t.poll.thankyou}</p>
              </div>
            )}
          </div>
        </div>
