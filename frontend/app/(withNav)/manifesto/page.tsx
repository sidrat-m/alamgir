...
export default function ManifestoPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="py-12 sm:py-16 md:py-24 bg-linear-to-br from-cyan-950/80 via-green-800/70 to-cyan-950/80 text-white relative overflow-hidden">
      ...
      {/* Vision */}
      <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-b from-whilte-900 to-stone-200 border-b">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4 sm:gap-5">
                    <div className="mt-1 flex h-12 w-12 items-center justify-center rounded-3xl bg-gradient-to-br from-green-600 to-cyan-800 text-white">
                      <Icon className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl font-serif font-semibold text-green-800 hover:text-cyen-900 transition-colors">
                        {section.title}
                      </h3>
                      
                    </div>
                  </div>
                  <ul className="mt-4 sm:mt-5 space-y-3 sm:space-y-4 text-sm sm:text-lg text-cyan-950">
