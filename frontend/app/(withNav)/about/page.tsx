...
export default function AboutPage() {
  ...
  return (
    <>
      {/* Hero / header */}
      <section className="py-16 md:py-24 bg-linear-to-br from-cyan-950/80 via-green-800/70 to-cyan-950/80 text-white relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="relative max-w-sm mx-auto">
                ...
                <div className="absolute -bottom-8 -right-6 w-32 h-32 bg-cyan-500/40 rounded-full blur-2xl" />
                ...
                <ul className="space-y-3">
                  {data.skills.left.map((skill: string, idx: number) => (
                    <li key={idx} className="flex items-center gap-3 text-stone-700">
                      <span className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-900 shrink-0">
                        <Check className="w-3 h-3" />
                      </span>
